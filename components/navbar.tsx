  ...
  const closeDropDown = () => {
    ...
    <div>
        ...
        >
            ...
            <div onClick={scrollToShopifyStores} className="hover:text-gray-50">Data Analysis</div>
            <div onClick={scrollToShopifyStores} className="hover:text-gray-50">Custom Software</div>
